...
<body>
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative">
            <h2>Welcome to <span>Hire Quest</span></h2>
            <p>Lets Get you <span>HIRED<span></p>
            <div class="d-flex">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
                        <div class="service-item position-relative">
                            ...
                            <p>Register your institution here to boost your placements.</p>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        <div class="">
                            <div class="" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <ul>
                                    <li></i> Developing the students to meet the Industries recruitment process.
                                    </li>
                                    <li></i> To motivate students to develop Technical knowledge and soft skills in
                                        terms of career planning, goal setting.
                                    </li>
                                    <li></i> To produce world-class professionals who have excellent analytical skills,
