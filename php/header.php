 <header id="header" class="header fixed-top" data-scrollto-offset="0">
     ...
     <div class="container-fluid d-flex align-items-center justify-content-between">
         ...
         <img src="assets/img/scs-logo-1.png" />
         </a>
             ...
             <ul>
                 ...
                 <li class="dropdown"><a href="login.php"><span>Login</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                     <ul>
                         ...
                         <li><a href="login-college.php">College Login</a></li>
                 ...
                 <li class="dropdown"><a href="login.php"><span>Register</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                     <ul>
                         ...
                         <li><a href="register-college.php">College Register</a></li>
                         <li><a href="register-company.php">Company Register</a></li>
