...
if (isset($_SESSION['id_user']) || isset($_SESSION['id_college'])) {
...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  <div class="login-box content:centre">
    ...
    <div class=" login-box-body bg-blue-200 text-black text-xl">
      <p class="text-white text-2xl login-box-msg text-black">College Representative</p>

      <form method="post" action="checkcollegelogin.php">
        ...
        <div class="row">
          ...
          <div class=" col-xs-12">
              ...
              ?>
              <?php
              if (isset($_SESSION['collegeLoginError'])) {
              ?>
                <div>
                  <p class="text-center"><?php echo $_SESSION['collegeLoginError'] ?></p>
                </div>
              <?php
                unset($_SESSION['collegeLoginError']);
              }
              ?>
          </div>
        </div>
    ...
    <a class="text-xl text-black" href=" register-college.php">Create new account</a>
    <!-- /.login-box-body -->
  </div>
  <!-- /.login-box -->
