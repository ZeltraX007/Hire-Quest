              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="colleges.php"><i class="fa fa-arrow-circle-o-right"></i> Colleges</a></li>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <span class="info-box-icon bg-light-blue-active"><i class="ion ion-briefcase"></i></span>
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <span class="info-box-icon bg-navy-active"><i class="ion ion-briefcase"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-text">Colleges</span>
                      <?php
                      $sql = "SELECT * FROM college WHERE active='1'";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        $totalno = $result->num_rows;
                      } else {
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <span class="info-box-icon bg-navy-active"><i class="ion ion-briefcase"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-text">Pending College Approval</span>
                      <?php
                      $sql = "SELECT * FROM college WHERE active='2'";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        $totalno = $result->num_rows;
                      } else {
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <span class="info-box-icon bg-olive-active"><i class="ion ion-person-stalker"></i></span>
                    <div class="info-box-content">
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <span class="info-box-icon bg-cyan"><i class="ion ion-ios-browsers"></i></span>
                    <div class="info-box-content">
