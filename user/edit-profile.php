                    ...
                    <div class="row">
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="hsc" placeholder="Percentage/CGPA" value="<?php echo $row['hsc']; ?>" readonly>
                        </div>
                        <div class="form-group">
                          <label for="Marks">SSC Marks</label>
                          <input type="text" class="form-control input-lg" id="Marks" name="ssc" placeholder="Percentage/CGPA" value="<?php echo $row['ssc']; ?>" readonly>
                        </div>
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="qualification" name="qualification" placeholder="Highest Qualification" value="<?php echo $row['qualification']; ?>" readonly>
                        </div>
                        <div class="form-group">
                          <label for="stream">Stream</label>
                          <input type="text" class="form-control input-lg" id="stream" name="stream" placeholder="stream" value="<?php echo $row['stream']; ?>" readonly>
                        </div>
                        <div class="form-group">
                          <label>Skills</label>
                          <textarea class="form-control input-lg" rows="4" name="skills" readonly><?php echo $row['skills']; ?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="ug" placeholder="Percentage/CGPA" value="<?php echo $row['ug']; ?>" readonly>
                        </div>
                        <div class="form-group">
                          <label for="Marks">PG Marks</label>
                          <input type="text" class="form-control input-lg" id="Marks" name="pg" placeholder="Percentage/CGPA" value="<?php echo $row['pg']; ?>" readonly>
                        </div>
                        <div class="form-group">
