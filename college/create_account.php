...
<body class="hold-transition skin-green sidebar-mini">
  ...
  <?php
  include 'register_page_header.php';
  ?>
      ...
      <section class="content-header">
        <div class="container">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            <h3 class="text-center margin-bottom-20">Create Your Profile for Student</h3>
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="10 Marks" name="hsc" placeholder="hsc">
                </div> 
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="10 Marks" name="ug" placeholder="ug">
                </div>  
                <div class="form-group checkbox">
                  <label><input type="checkbox"> I accept terms & conditions</label>
                </div>
                <div class="form-group">
                  <button class="btn btn-flat btn-success">Register
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="designation" name="ssl" placeholder="ssl">
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="designation" name="pg" placeholder="pg">
                </div>
