              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  ...
                  <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                    ...
                    <li class="active"><a href="manage_acount.php"><i class="fa fa-address-card-o"></i>Edit a Students Profile</a></li>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="edit_account.php?id=<?php echo $row['id_user']; ?>">Edit</a></td>
                            </tr>
